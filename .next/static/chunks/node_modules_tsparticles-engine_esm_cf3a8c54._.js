...
class Vector3d {
    ...
    constructor(xOrCoords, y, z){
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tsparticles$2d$engine$2f$esm$2f$Utils$2f$Utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isNumber"])(xOrCoords) && xOrCoords) {
            ...
            throw new Error("".concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tsparticles$2d$engine$2f$esm$2f$Core$2f$Utils$2f$Constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["errorPrefix"], " Vector3d not initialized correctly"));
        }
    }
}
}),
...
function setRandom() {
    let rnd = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : Math.random;
    _random = rnd;
}
function getRandom() {
...
function calcPositionOrRandomFromSize(data) {
    ...
    var _data_position_x, _data_position_y;
    return {
        x: ((_data_position_x = (_data_position = data.position) === null || _data_position === void 0 ? void 0 : _data_position.x) !== null && _data_position_x !== void 0 ? _data_position_x : getRandom() * 100) * data.size.width / 100,
        y: ((_data_position_y = (_data_position1 = data.position) === null || _data_position1 === void 0 ? void 0 : _data_position1.y) !== null && _data_position_y !== void 0 ? _data_position_y : getRandom() * 100) * data.size.height / 100
    };
}
...
function calcExactPositionOrRandomFromSize(data) {
    ...
    var _data_position_x, _data_position_y;
    return {
        x: (_data_position_x = (_data_position = data.position) === null || _data_position === void 0 ? void 0 : _data_position.x) !== null && _data_position_x !== void 0 ? _data_position_x : getRandom() * data.size.width,
        y: (_data_position_y = (_data_position1 = data.position) === null || _data_position1 === void 0 ? void 0 : _data_position1.y) !== null && _data_position_y !== void 0 ? _data_position_y : getRandom() * data.size.height
    };
}
...
function itemFromArray(array, index) {
    let useIndex = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
...
function rangeColorToRgb(input, index) {
    let useIndex = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
    if (!input) {
        return;
    }
...
function rangeColorToHsl(color, index) {
    let useIndex = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
...
function getLinkColor(p1, p2, linkColor) {
    if (linkColor === randomColorValue) {
        ...
        var _p1_getFillColor, _p2_getFillColor;
        const sourceColor = (_p1_getFillColor = p1.getFillColor()) !== null && _p1_getFillColor !== void 0 ? _p1_getFillColor : p1.getStrokeColor(), destColor = (_p2_getFillColor = p2 === null || p2 === void 0 ? void 0 : p2.getFillColor()) !== null && _p2_getFillColor !== void 0 ? _p2_getFillColor : p2 === null || p2 === void 0 ? void 0 : p2.getStrokeColor();
...
function drawParticle(data) {
    ...
    var _transform_a, _transform_b, _transform_c, _transform_d;
    const pos = particle.getPosition(), angle = particle.rotation + (particle.pathRotation ? particle.velocity.angle : 0), rotateData = {
        sin: Math.sin(angle),
        cos: Math.cos(angle)
    }, transformData = {
        a: rotateData.cos * ((_transform_a = transform.a) !== null && _transform_a !== void 0 ? _transform_a : 1),
        b: rotateData.sin * ((_transform_b = transform.b) !== null && _transform_b !== void 0 ? _transform_b : 1),
        c: -rotateData.sin * ((_transform_c = transform.c) !== null && _transform_c !== void 0 ? _transform_c : 1),
        d: rotateData.cos * ((_transform_d = transform.d) !== null && _transform_d !== void 0 ? _transform_d : 1)
    };
    ...
    var _particle_strokeWidth;
    const strokeWidth = (_particle_strokeWidth = particle.strokeWidth) !== null && _particle_strokeWidth !== void 0 ? _particle_strokeWidth : 0;
...
function setTransformValue(factor, newFactor, key) {
    ...
    if (newValue !== undefined) {
        var _factor_key;
        factor[key] = ((_factor_key = factor[key]) !== null && _factor_key !== void 0 ? _factor_key : 1) * newValue;
    }
}
class Canvas {
    get _fullScreen() {
    ...
    drawParticle(particle, delta) {
        ...
        this.draw((ctx)=>{
            ...
            const container = this.container, options = container.actualOptions, zIndexOptions = particle.options.zIndex, zOpacityFactor = (1 - particle.zIndexFactor) ** zIndexOptions.opacityRate, opacity = (_ref = (_particle_bubble_opacity = particle.bubble.opacity) !== null && _particle_bubble_opacity !== void 0 ? _particle_bubble_opacity : (_particle_opacity = particle.opacity) === null || _particle_opacity === void 0 ? void 0 : _particle_opacity.value) !== null && _ref !== void 0 ? _ref : 1, strokeOpacity = (_particle_strokeOpacity = particle.strokeOpacity) !== null && _particle_strokeOpacity !== void 0 ? _particle_strokeOpacity : opacity, zOpacity = opacity * zOpacityFactor, zStrokeOpacity = strokeOpacity * zOpacityFactor, transform = {}, colorStyles = {
        ...
        this._mouseTouchMove = (e)=>{
            ...
            if (e.type.startsWith("pointer")) {
                ...
                if (canvasEl) {
                    ...
                    pos = {
                        x: lastTouch.clientX - ((_canvasRect_left = canvasRect.left) !== null && _canvasRect_left !== void 0 ? _canvasRect_left : 0),
                        y: lastTouch.clientY - ((_canvasRect_top = canvasRect.top) !== null && _canvasRect_top !== void 0 ? _canvasRect_top : 0)
                    };
                }
            }
...
class DivEvent {
    ...
    load(data) {
        ...
        var _data_ids, _ref;
        const ids = (_ref = (_data_ids = data.ids) !== null && _data_ids !== void 0 ? _data_ids : data.elementId) !== null && _ref !== void 0 ? _ref : data.el;
        if (ids !== undefined) {
            this.ids = ids;
        }
...
class Events {
    ...
    load(data) {
        ...
        var _data_onClick;
        this.onClick.load((_data_onClick = data.onClick) !== null && _data_onClick !== void 0 ? _data_onClick : data.onclick);
        var _data_onDiv;
        const onDiv = (_data_onDiv = data.onDiv) !== null && _data_onDiv !== void 0 ? _data_onDiv : data.ondiv;
        if (onDiv !== undefined) {
        ...
        var _data_onHover;
        this.onHover.load((_data_onHover = data.onHover) !== null && _data_onHover !== void 0 ? _data_onHover : data.onhover);
...
class Interactivity {
    ...
    load(data) {
        ...
        var _data_detectsOn;
        const detectsOn = (_data_detectsOn = data.detectsOn) !== null && _data_detectsOn !== void 0 ? _data_detectsOn : data.detect_on;
...
class ManualParticle {
    load(data) {
        ...
        if (data.position) {
            ...
            this.position = {
                x: (_data_position_x = data.position.x) !== null && _data_position_x !== void 0 ? _data_position_x : 50,
                y: (_data_position_y = data.position.y) !== null && _data_position_y !== void 0 ? _data_position_y : 50,
                mode: (_data_position_mode = data.position.mode) !== null && _data_position_mode !== void 0 ? _data_position_mode : "percent"
            };
        }
        if (data.options) {
...
class AnimationValueWithRandom extends ValueWithRandom {
    ...
    load(data) {
        ...
        var _data_animation;
        const animation = (_data_animation = data.animation) !== null && _data_animation !== void 0 ? _data_animation : data.anim;
...
class MoveAttract {
    ...
    load(data) {
        var _data_rotate, _data_rotate1;
        if (!data) {
            return;
        }
        ...
        var _data_rotate_x;
        const rotateX = (_data_rotate_x = (_data_rotate = data.rotate) === null || _data_rotate === void 0 ? void 0 : _data_rotate.x) !== null && _data_rotate_x !== void 0 ? _data_rotate_x : data.rotateX;
        if (rotateX !== undefined) {
            this.rotate.x = rotateX;
        }
        var _data_rotate_y;
        const rotateY = (_data_rotate_y = (_data_rotate1 = data.rotate) === null || _data_rotate1 === void 0 ? void 0 : _data_rotate1.y) !== null && _data_rotate_y !== void 0 ? _data_rotate_y : data.rotateY;
...
class Move {
    ...
    load(data) {
        ...
        var _data_outModes, _ref;
        const outModes = (_ref = (_data_outModes = data.outModes) !== null && _data_outModes !== void 0 ? _data_outModes : data.outMode) !== null && _ref !== void 0 ? _ref : data.out_mode;
        ...
        var _data_path;
        this.path.load((_data_path = data.path) !== null && _data_path !== void 0 ? _data_path : data.noise);
...
class ParticlesDensity {
    ...
    load(data) {
        ...
        var _data_width, _ref;
        const width = (_ref = (_data_width = data.width) !== null && _data_width !== void 0 ? _data_width : data.area) !== null && _ref !== void 0 ? _ref : data.value_area;
        if (width !== undefined) {
            this.width = width;
        }
        var _data_height;
        const height = (_data_height = data.height) !== null && _data_height !== void 0 ? _data_height : data.factor;
        if (height !== undefined) {
            this.height = height;
        }
    }
...
class ParticlesNumber {
    ...
    load(data) {
        ...
        var _data_limit;
        const limit = (_data_limit = data.limit) !== null && _data_limit !== void 0 ? _data_limit : data.max;
        if (limit !== undefined) {
            this.limit = limit;
        }
        if (data.value !== undefined) {
...
class Shape {
    get character() {
        var _this_options_charKey;
        return (_this_options_charKey = this.options[charKey]) !== null && _this_options_charKey !== void 0 ? _this_options_charKey : this.options[charAltKey];
    }
    set character(value) {
    ...
    get image() {
        var _this_options_imageKey;
        return (_this_options_imageKey = this.options[imageKey]) !== null && _this_options_imageKey !== void 0 ? _this_options_imageKey : this.options[imageAltKey];
    }
    set image(value) {
    ...
    get polygon() {
        var _this_options_polygonKey;
        return (_this_options_polygonKey = this.options[polygonKey]) !== null && _this_options_polygonKey !== void 0 ? _this_options_polygonKey : this.options[polygonAltKey];
    }
    set polygon(value) {
    ...
    load(data) {
        ...
        var _data_options;
        const options = (_data_options = data.options) !== null && _data_options !== void 0 ? _data_options : data.custom;
        if (options !== undefined) {
            for(const shape in options){
                const item = options[shape];
                if (item) {
                    var _this_options_shape;
                    this.options[shape] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tsparticles$2d$engine$2f$esm$2f$Utils$2f$Utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deepExtend"])((_this_options_shape = this.options[shape]) !== null && _this_options_shape !== void 0 ? _this_options_shape : {}, item);
                }
            }
        }
        ...
        var _data_image;
        this.loadShape((_data_image = data.image) !== null && _data_image !== void 0 ? _data_image : data.images, imageKey, imageAltKey, true);
    ...
    constructor(){
        this.loadShape = (item, mainKey, altKey, altOverride)=>{
            ...
            var _this_options_mainKey;
            this.options[mainKey] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tsparticles$2d$engine$2f$esm$2f$Utils$2f$Utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deepExtend"])((_this_options_mainKey = this.options[mainKey]) !== null && _this_options_mainKey !== void 0 ? _this_options_mainKey : emptyValue, item);
            if (!this.options[altKey] || altOverride) {
                var _this_options_altKey;
                this.options[altKey] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tsparticles$2d$engine$2f$esm$2f$Utils$2f$Utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deepExtend"])((_this_options_altKey = this.options[altKey]) !== null && _this_options_altKey !== void 0 ? _this_options_altKey : emptyValue, item);
            }
        };
        this.close = true;
        this.fill = true;
...
class ParticlesOptions {
    load(data) {
        var _data_move, _data_move1, _data_shape;
        if (!data) {
            return;
        }
        this.bounce.load(data.bounce);
        ...
        if (data.groups !== undefined) {
            for(const group in data.groups){
                ...
                if (item !== undefined) {
                    ...
                    this.groups[group] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tsparticles$2d$engine$2f$esm$2f$Utils$2f$Utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deepExtend"])((_this_groups_group = this.groups[group]) !== null && _this_groups_group !== void 0 ? _this_groups_group : {}, item);
                }
            }
        }
        ...
        var _data_move_collisions;
        const collisions = (_data_move_collisions = (_data_move = data.move) === null || _data_move === void 0 ? void 0 : _data_move.collisions) !== null && _data_move_collisions !== void 0 ? _data_move_collisions : (_data_move1 = data.move) === null || _data_move1 === void 0 ? void 0 : _data_move1.bounce;
        ...
        var _data_stroke;
        const strokeToLoad = (_data_stroke = data.stroke) !== null && _data_stroke !== void 0 ? _data_stroke : (_data_shape = data.shape) === null || _data_shape === void 0 ? void 0 : _data_shape.stroke;
        if (strokeToLoad) {
...
class Options {
    ...
    load(data) {
        ...
        var _data_detectRetina;
        const detectRetina = (_data_detectRetina = data.detectRetina) !== null && _data_detectRetina !== void 0 ? _data_detectRetina : data.retina_detect;
        ...
        var _data_fpsLimit;
        const fpsLimit = (_data_fpsLimit = data.fpsLimit) !== null && _data_fpsLimit !== void 0 ? _data_fpsLimit : data.fps_limit;
        ...
        var _data_fullScreen;
        const fullScreen = (_data_fullScreen = data.fullScreen) !== null && _data_fullScreen !== void 0 ? _data_fullScreen : data.backgroundMode;
        ...
        this.defaultThemes.dark = (_this__findDefaultTheme = this._findDefaultTheme("dark")) === null || _this__findDefaultTheme === void 0 ? void 0 : _this__findDefaultTheme.name;
        this.defaultThemes.light = (_this__findDefaultTheme1 = this._findDefaultTheme("light")) === null || _this__findDefaultTheme1 === void 0 ? void 0 : _this__findDefaultTheme1.name;
    }
    ...
    constructor(engine, container){
        this._findDefaultTheme = (mode)=>{
            ...
            return (_this_themes_find = this.themes.find((theme)=>theme.default.value && theme.default.mode === mode)) !== null && _this_themes_find !== void 0 ? _this_themes_find : this.themes.find((theme)=>theme.default.value && theme.default.mode === "any");
        };
...
class Particle {
    ...
    getFillColor() {
        ...
        return this._getRollColor((_this_bubble_color = this.bubble.color) !== null && _this_bubble_color !== void 0 ? _this_bubble_color : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tsparticles$2d$engine$2f$esm$2f$Utils$2f$ColorUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getHslFromAnimation"])(this.color));
    }
    getMass() {
    ...
    getStrokeColor() {
        var _this_bubble_color;
        return this._getRollColor((_this_bubble_color = this.bubble.color) !== null && _this_bubble_color !== void 0 ? _this_bubble_color : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tsparticles$2d$engine$2f$esm$2f$Utils$2f$ColorUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getHslFromAnimation"])(this.strokeColor));
    }
    init(id, position, overrideOptions, group) {
        ...
        var _shapeData_fill;
        this.fill = (_shapeData_fill = shapeData === null || shapeData === void 0 ? void 0 : shapeData.fill) !== null && _shapeData_fill !== void 0 ? _shapeData_fill : particlesOptions.shape.fill;
        var _shapeData_close;
        this.close = (_shapeData_close = shapeData === null || shapeData === void 0 ? void 0 : shapeData.close) !== null && _shapeData_close !== void 0 ? _shapeData_close : particlesOptions.shape.close;
    ...
    constructor(engine, id, container, position, overrideOptions, group){
        ...
        this._calcPosition = function(container, position, zIndex) {
            let tryCount = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 0;
            for (const [, plugin] of container.plugins){
            ...
            const canvasSize = container.canvas.size, exactPosition = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tsparticles$2d$engine$2f$esm$2f$Utils$2f$NumberUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calcExactPositionOrRandomFromSize"])({
                size: canvasSize,
                position: position
            }), pos = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tsparticles$2d$engine$2f$esm$2f$Core$2f$Utils$2f$Vector3d$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector3d"].create(exactPosition.x, exactPosition.y, zIndex), radius = _this.getRadius(), outModes = _this.options.move.outModes, fixHorizontal = (outMode)=>{
                fixOutMode({
                    outMode,
                    checkModes: [
                        "bounce",
        ...
        this._checkOverlap = function(pos) {
            let tryCount = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0;
            ...
            if (retries >= 0 && tryCount > retries) {
                throw new Error("".concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tsparticles$2d$engine$2f$esm$2f$Core$2f$Utils$2f$Constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["errorPrefix"], " particle is overlapping and can't be placed"));
            }
            return !!_this.container.particles.find((particle)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tsparticles$2d$engine$2f$esm$2f$Utils$2f$NumberUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDistance"])(pos, particle.position) < radius + particle.getRadius());
        };
        this._getRollColor = (color)=>{
            ...
            const backFactor = this.roll.horizontal && this.roll.vertical ? 2 : 1, backSum = this.roll.horizontal ? Math.PI / 2 : 0, rolled = Math.floor((((_this_roll_angle = this.roll.angle) !== null && _this_roll_angle !== void 0 ? _this_roll_angle : 0) + backSum) / (Math.PI / backFactor)) % 2;
            if (!rolled) {
                return color;
            }
            if (this.backColor) {
        ...
        this._initPosition = (position)=>{
            ...
            this.moveCenter = {
                ...
                radius: (_this_options_move_center_radius = this.options.move.center.radius) !== null && _this_options_move_center_radius !== void 0 ? _this_options_move_center_radius : 0,
...
class Particles {
    ...
    init() {
        ...
        if (!handled) {
            for(const group in options.particles.groups){
                ...
                for(let i = this.count, j = 0; j < ((_groupOptions_number = groupOptions.number) === null || _groupOptions_number === void 0 ? void 0 : _groupOptions_number.value) && i < options.particles.number.value; i++, j++){
    ...
    removeAt(index) {
        let quantity = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 1, group = arguments.length > 2 ? arguments[2] : void 0, override = arguments.length > 3 ? arguments[3] : void 0;
    ...
    constructor(engine, container){
        ...
        this._pushParticle = (position, overrideOptions, group, initializer)=>{
            try {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tsparticles$2d$engine$2f$esm$2f$Utils$2f$Utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLogger"])().warning("".concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tsparticles$2d$engine$2f$esm$2f$Core$2f$Utils$2f$Constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["errorPrefix"], " adding particle: ").concat(e));
                return;
            }
        };
...
function initDelta(value) {
    let fpsLimit = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 60, smooth = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
    return {
        value,
...
class Container {
    ...
    async export(type) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tsparticles$2d$engine$2f$esm$2f$Utils$2f$Utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLogger"])().error("".concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tsparticles$2d$engine$2f$esm$2f$Core$2f$Utils$2f$Constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["errorPrefix"], " - Export plugin with type ").concat(type, " not found"));
    }
    getAnimationStatus() {
    ...
    constructor(engine, id, sourceOptions){
        ...
        this._nextFrame = async (timestamp)=>{
            try {
                ...
                var _this_lastFrameTime;
                (_this_lastFrameTime = this.lastFrameTime) !== null && _this_lastFrameTime !== void 0 ? _this_lastFrameTime : this.lastFrameTime = timestamp;
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tsparticles$2d$engine$2f$esm$2f$Utils$2f$Utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLogger"])().error("".concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tsparticles$2d$engine$2f$esm$2f$Core$2f$Utils$2f$Constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["errorPrefix"], " in animation loop"), e);
            }
        };
        this._engine = engine;
        this.fpsLimit = 120;
...
async function getDataFromUrl(data) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tsparticles$2d$engine$2f$esm$2f$Utils$2f$Utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLogger"])().error("".concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tsparticles$2d$engine$2f$esm$2f$Core$2f$Utils$2f$Constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["errorPrefix"], " ").concat(response.status, " while retrieving config file"));
    return data.fallback;
}
...
class Engine {
    ...
    addConfig(nameOrConfig, config) {
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tsparticles$2d$engine$2f$esm$2f$Utils$2f$Utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isString"])(nameOrConfig)) {
            ...
            var _nameOrConfig_name;
            this._configs.set((_nameOrConfig_name = nameOrConfig.name) !== null && _nameOrConfig_name !== void 0 ? _nameOrConfig_name : "default", nameOrConfig);
        }
    }
    addEventListener(type, listener) {
    ...
    async addInteractor(name, interactorInitializer) {
        let refresh = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
    ...
    async addPreset(preset, options) {
        let override = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false, refresh = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : true;
        this.plugins.addPreset(preset, options, override);
        await this.refresh(refresh);
    }
    async addShape(shape, drawer, initOrRefresh, afterEffectOrRefresh, destroyOrRefresh) {
        let refresh = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : true;
        let customDrawer;
    ...
    async refresh() {
        let refresh = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true;
        if (!refresh) {
            return;
        }
    ...
    setOnClickHandler(callback) {
        const dom = this.dom();
        if (!dom.length) {
            throw new Error("".concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tsparticles$2d$engine$2f$esm$2f$Core$2f$Utils$2f$Constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["errorPrefix"], " can only set click handlers after calling tsParticles.load()"));
        }
    ...
    async _loadParams(params) {
        var _params_id;
        const id = (_params_id = params.id) !== null && _params_id !== void 0 ? _params_id : "tsparticles".concat(Math.floor((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tsparticles$2d$engine$2f$esm$2f$Utils$2f$NumberUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRandom"])() * 10000)), { index, url } = params, options = url ? await getDataFromUrl({
            fallback: params.options,
            url,
            index
        }) : params.options;
        var _params_element;
        let domContainer = (_params_element = params.element) !== null && _params_element !== void 0 ? _params_element : document.getElementById(id);
        if (!domContainer) {
...
//# sourceMappingURL=node_modules_tsparticles-engine_esm_cf3a8c54._.js.map